...
class CassandraClient implements \cassandra\CassandraIf
{
    ...
    public function recv_login()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_login_result',
    ...
    public function recv_set_keyspace()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_set_keyspace_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_get_slice()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_get_slice_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_get_count()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_get_count_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_multiget_slice()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_multiget_slice_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_multiget_count()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_multiget_count_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_get_range_slices()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_get_range_slices_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_get_paged_slice()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_get_paged_slice_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_get_indexed_slices()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_get_indexed_slices_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_insert()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_insert_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_add()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_add_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_cas()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_cas_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_remove()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_remove_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_remove_counter()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_remove_counter_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_batch_mutate()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_batch_mutate_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_atomic_batch_mutate()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_atomic_batch_mutate_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_truncate()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_truncate_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_get_multi_slice()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_get_multi_slice_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_describe_schema_versions()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_describe_schema_versions_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_describe_keyspaces()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_describe_keyspaces_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_describe_cluster_name()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_describe_cluster_name_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_describe_version()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_describe_version_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_describe_ring()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_describe_ring_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_describe_local_ring()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_describe_local_ring_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_describe_token_map()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_describe_token_map_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_describe_partitioner()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_describe_partitioner_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_describe_snitch()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_describe_snitch_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_describe_keyspace()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_describe_keyspace_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_describe_splits()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_describe_splits_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_trace_next_query()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_trace_next_query_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_describe_splits_ex()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_describe_splits_ex_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_system_add_column_family()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_system_add_column_family_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_system_drop_column_family()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_system_drop_column_family_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_system_add_keyspace()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_system_add_keyspace_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_system_drop_keyspace()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_system_drop_keyspace_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_system_update_keyspace()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_system_update_keyspace_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_system_update_column_family()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_system_update_column_family_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_execute_cql_query()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_execute_cql_query_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_execute_cql3_query()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_execute_cql3_query_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_prepare_cql_query()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_prepare_cql_query_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_prepare_cql3_query()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_prepare_cql3_query_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_execute_prepared_cql_query()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_execute_prepared_cql_query_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_execute_prepared_cql3_query()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_execute_prepared_cql3_query_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
    ...
    public function recv_set_cql_version()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\cassandra\Cassandra_set_cql_version_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
