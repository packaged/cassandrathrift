      ...
      $xfer += $output->writeFieldBegin('success', TType::MAP, 0);
      {
        $output->writeMapBegin(TType::STRING, TType::LST, count($this->success));
        {
          foreach ($this->success as $kiter195 => $viter196)
          {
            ...
            {
              $output->writeListBegin(TType::STRUCT, count($viter196));
              {
                foreach ($viter196 as $iter197)
                {
  ...
  public function write($output) {
    ...
    if ($this->mutation_map !== null) {
      ...
      $xfer += $output->writeFieldBegin('mutation_map', TType::MAP, 1);
      {
        ...
        {
          foreach ($this->mutation_map as $kiter255 => $viter256)
          {
            $xfer += $output->writeString($kiter255);
            {
              $output->writeMapBegin(TType::STRING, TType::LST, count($viter256));
              {
                foreach ($viter256 as $kiter257 => $viter258)
                {
                  $xfer += $output->writeString($kiter257);
                  {
                    $output->writeListBegin(TType::STRUCT, count($viter258));
                    {
                      foreach ($viter258 as $iter259)
                      {
        ...
        case 1:
          if ($ftype == TType::MAP) {
            ...
            for ($_i264 = 0; $_i264 < $_size260; ++$_i264)
            {
              ...
              $xfer += $input->readMapEnd();
              $this->mutation_map[$key265] = $val266;
            }
            $xfer += $input->readMapEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->mutation_map !== null) {
      ...
      $xfer += $output->writeFieldBegin('mutation_map', TType::MAP, 1);
      {
        $output->writeMapBegin(TType::STRING, TType::MAP, count($this->mutation_map));
        {
          foreach ($this->mutation_map as $kiter280 => $viter281)
          {
            $xfer += $output->writeString($kiter280);
            {
              $output->writeMapBegin(TType::STRING, TType::LST, count($viter281));
              {
                foreach ($viter281 as $kiter282 => $viter283)
                {
  ...
  public function write($output) {
    ...
    if ($this->success !== null) {
      ...
      $xfer += $output->writeFieldBegin('success', TType::MAP, 0);
      {
        $output->writeMapBegin(TType::STRING, TType::LST, count($this->success));
        {
          foreach ($this->success as $kiter298 => $viter299)
          {
            $xfer += $output->writeString($kiter298);
            {
              $output->writeListBegin(TType::STRING, count($viter299));
              {
                foreach ($viter299 as $iter300)
                {
  ...
  public function write($output) {
    ...
    if ($this->success !== null) {
      ...
      $xfer += $output->writeFieldBegin('success', TType::MAP, 0);
      {
        ...
        {
          foreach ($this->success as $kiter322 => $viter323)
          {
  ...
  public function write($output) {
    ...
    if ($this->values !== null) {
      ...
      $xfer += $output->writeFieldBegin('values', TType::LST, 2);
      {
        $output->writeListBegin(TType::STRING, count($this->values));
        {
          foreach ($this->values as $iter351)
          {
